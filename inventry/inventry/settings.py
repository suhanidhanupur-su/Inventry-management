...
INSTALLED_APPS = [
    ...
    'managementsystem' ##Second Changes App Name
]
...
ROOT_URLCONF = 'inventry.urls'##Check Changes Project name
...
WSGI_APPLICATION = 'inventry.wsgi.application'##Check Changes Project Name
